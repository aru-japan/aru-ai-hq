...
| [Automation Scripts](docs/Automation-Scripts.md) | Version 3で実装した自動化スクリプト（Notion自動化＋AI Gateway＋Article/Translation/SNSの3段レビュー＋Version 4準備のArticle Freshness Monitor・Coverage Analyzer・Editorial Planner・Publishing Center）の一覧と実行方法 |
